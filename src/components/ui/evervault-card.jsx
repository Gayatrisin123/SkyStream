...
return (
  ...
  >
    <div
      ...
      className="group/card rounded-3xl relative overflow-hidden bg-transparent flex items-center justify-center"
      style={{ width: "100%", height: "100%" }}
    >
      <CardPattern mouseX={mouseX} mouseY={mouseY} randomString={randomString} />
      <div className="relative z-10 flex items-center justify-center">
        <div
          className="relative rounded-full flex items-center justify-center text-white font-bold text-xl"
